			...
			<div class="row">
				<div class="col-md-5">
					...
					<div class="form-group">
						...
						<input type="date" id="dateinForm" class="form-control form-control-sm" name="date" value="<?php echo isset($date) ? date("Y-m-d", strtotime($date)) : '' ?>" required>
					</div>
					<div class="form-group">
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button type="button" class="btn btn-secondary" data-dismiss="modal" style="background-color: #ED1111;">Close</button>
					<!-- <button class="btn btn-secondary" style="background-color: #ED1111;" type="button" onclick="location.href = 'index.php?page=task_list'">Cancel</button> -->
				</div>
			</div>
		</div>
	</form>
