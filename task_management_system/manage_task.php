	...
	<form action="" id="manage-task">
		...
		<div class="card-footer border-top border-info">
			<div class="d-flex w-100 justify-content-center align-items-center">
				<button type="submit" class="btn btn-flat mx-2" form="manage-task" style="background-color:#26C378;color: white;">Save</button>
				<button type="button" class="btn btn-secondary" style="background-color: #ED1111;" data-dismiss="modal">Cancel</button>
			</div>
		</div>
	</form>
</div>
