...
?>
<!-- Info boxes -->
<div class="card" style="background-image: url('assets/uploads/fbc.png');">
 <div class="col-12">
          <div class="card">
            <div class="card" style="background-image: url('assets/uploads/home-back.png');">
            <div class="card-body">
  ...
  <?php
    ...
    ?>
      ...
      <div class="row">
        <div class="card card-outline card-success" class="col-md-8"> <div class="card" style="background-image: url('assets/uploads/fbcc.png');">
