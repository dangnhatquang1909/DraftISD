...
<div class="col-lg-12" class="card-header" style="background-image: url('assets/uploads/fbc.png');">
	<div class="card card-outline card-success" style="background-image: url('assets/uploads/prolist.png');">
