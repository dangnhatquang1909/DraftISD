...
?>
<div class="col-lg-12"style="background-image: url('assets/uploads/viewproject.png');">
	<div class="row">
		<div class="col-md-12"style="background-color: #FCE8E8;">
			<div class="callout callout-info"style="background-image: url('assets/uploads/viewproject.png');">
				<div class="col-md-12">
					<div class="row">
						<div class="col-sm-6">
							<dl>
	...
	<div class="row">
		<div class="col-md-4">
			<div class="card card-outline card-primary">
				<div class="card-header" style="background-color: #FCE8E8;">
		...
		<div class="col-md-8">
			<div class="card card-outline card-primary">
				...
				<div class="card-body p-0"style="background-color: #FCF8F3;">
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header"style="background-color: #FCE8E8;">
					...
					<div class="card-tools" style="background-color: #89A985;">
